...
def run_bot():
    ...
    telegram_app.add_handler(CallbackQueryHandler(course_selected, pattern='^(class10|class12|btech)$'))
    telegram_app.add_handler(CallbackQueryHandler(stream_selected, pattern='^stream_'))
    telegram_app.add_handler(CallbackQueryHandler(btech_branch_selected, pattern='^branch_'))
    telegram_app.add_handler(CallbackQueryHandler(send_static_link, pattern='^static_link$'))
    telegram_app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_feedback))
